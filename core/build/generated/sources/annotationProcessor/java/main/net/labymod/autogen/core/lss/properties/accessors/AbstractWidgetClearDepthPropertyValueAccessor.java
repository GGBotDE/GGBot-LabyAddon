...
public final class AbstractWidgetClearDepthPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Boolean, Boolean> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.clearDepth();
  }

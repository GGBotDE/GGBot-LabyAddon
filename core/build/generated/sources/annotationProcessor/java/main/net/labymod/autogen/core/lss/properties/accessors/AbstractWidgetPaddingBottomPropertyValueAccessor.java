...
public final class AbstractWidgetPaddingBottomPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Float, Float> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.paddingBottom();
  }

...
public final class AbstractWidgetRenderChildrenPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Boolean, Boolean> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.renderChildren();
  }

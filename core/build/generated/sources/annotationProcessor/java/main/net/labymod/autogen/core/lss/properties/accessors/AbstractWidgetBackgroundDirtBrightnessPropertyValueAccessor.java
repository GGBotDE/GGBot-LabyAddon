...
public final class AbstractWidgetBackgroundDirtBrightnessPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Integer, Integer> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.backgroundDirtBrightness();
  }

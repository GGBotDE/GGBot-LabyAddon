...
public final class HorizontalListWidgetSpaceLeftPropertyValueAccessor implements PropertyValueAccessor<HorizontalListWidget, Float, Float> {
  @Override
  public LssProperty getProperty(HorizontalListWidget widget) {
    return widget.spaceLeft();
  }

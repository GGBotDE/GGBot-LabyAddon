...
public final class AbstractWidgetHeightPrecisionPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Float, Float> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.heightPrecision();
  }

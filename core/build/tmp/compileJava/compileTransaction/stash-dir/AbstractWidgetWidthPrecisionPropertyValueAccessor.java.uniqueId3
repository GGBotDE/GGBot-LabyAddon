...
public final class AbstractWidgetWidthPrecisionPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Float, Float> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.widthPrecision();
  }

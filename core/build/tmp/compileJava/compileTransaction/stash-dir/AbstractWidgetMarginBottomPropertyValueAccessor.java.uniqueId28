...
public final class AbstractWidgetMarginBottomPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Float, Float> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.marginBottom();
  }

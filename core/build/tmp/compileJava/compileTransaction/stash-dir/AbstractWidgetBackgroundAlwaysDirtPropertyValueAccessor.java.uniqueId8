...
public final class AbstractWidgetBackgroundAlwaysDirtPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Boolean, Boolean> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.backgroundAlwaysDirt();
  }

...
public final class AbstractWidgetHoverBoxDelayPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Integer, Integer> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.hoverBoxDelay();
  }

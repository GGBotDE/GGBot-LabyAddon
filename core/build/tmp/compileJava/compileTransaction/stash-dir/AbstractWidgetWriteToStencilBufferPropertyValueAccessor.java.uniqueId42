...
public final class AbstractWidgetWriteToStencilBufferPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Boolean, Boolean> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.writeToStencilBuffer();
  }

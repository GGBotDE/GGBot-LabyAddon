...
public final class AbstractWidgetPaddingLeftPropertyValueAccessor implements PropertyValueAccessor<AbstractWidget, Float, Float> {
  @Override
  public LssProperty getProperty(AbstractWidget widget) {
    return widget.paddingLeft();
  }
